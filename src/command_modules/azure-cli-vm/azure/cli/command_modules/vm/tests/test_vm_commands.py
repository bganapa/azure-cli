...
class VMUsageScenarioTest(VCRTestBase):
    ...
    def body(self):
        self.cmd('vm list-usage --location westus --debug',
...
class VMSizeListScenarioTest(VCRTestBase):
    ...
    def __init__(self, test_method):
        super(VMSizeListScenarioTest, self).__init__(__file__, test_method, debug=True)

    def test_vm_size_list(self):
        self.execute()

    def body(self):
        self.cmd('vm list-sizes --location westus --debug',
                 checks=JMESPathCheck('type(@)', 'array'))
